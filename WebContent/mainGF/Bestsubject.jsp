...
<%@page import="DTO.BestsubjectDTO"%>
<%@page import="DAO.BestsubjectDAO"%>


<%
	BestsubjectDAO dao = new BestsubjectDAO();
	BookinfoDAO dao2 = new BookinfoDAO();

	ArrayList<BestsubjectDTO> list = dao.select();
	ArrayList<BookInfoDTO> list2 = new ArrayList<>();
		
      for(int i = 0; i<list.size(); i++){
    	BestsubjectDTO dto4 = list.get(i);

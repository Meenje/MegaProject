...
<%@page import="DTO.BookrankDTO"%><!--바꾸고  -->
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="DAO.BookrankDAO"%><!--바꾸고  -->
...
<%
	...
	BookrankDAO dao = new BookrankDAO();//바꾸고
	BookinfoDAO dao2 = new BookinfoDAO();
//5개의 리스트를 가지고 오고,
	ArrayList<BookrankDTO> list = dao.selectALL();//바꾸고
	ArrayList<BookInfoDTO> list2 = new ArrayList<>();
		
      for(int i = 0; i<list.size(); i++){
    	BookrankDTO dto4 = list.get(i);
		BookInfoDTO dto5 = dao2.select2(dto4);//BookInfo에 새 메소드 필요
		list2.add(dto5);
	}
